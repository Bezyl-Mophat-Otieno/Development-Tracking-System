...
public class Issue {
    ...
    public Issue(String issueTitle, String description, String design, Date dateReported, Date
            dateClosed, int issueStatus, int developer,
                 int qa, int issueType, int issuePriority, double hoursTaken, double estimatedTime, long
                         projectID) {
        super();
